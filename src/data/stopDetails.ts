...
export const stopDetails: Record<string, StopDetails> = {
  ...
  bowling: { price: '$20–35', priceKind: 'estimate', priceNote: '이왕 칠거면 시설 좋은데서 치려고 해서 인당 25불 잡았어.(2시간) 만약에 좀 꾸진데 괜찮으면 아낄 수 있음', mapQuery: 'bowling Dallas Fort Worth Texas' },
  'home-sat-pm': { ...home, price: '$0' },
  truckyard: { price: '$20–40', priceKind: 'estimate', priceNote: '맥주만 간단히 기분내게 마실 예정. 먹을것도 파니까 출출하면 사드셈', mapQuery: 'Truck Yard 5624 Sears St Dallas TX 75206', website: 'https://truckyard.com/dallas/', source: { label: 'Truck Yard Dallas venue & menus', url: 'https://truckyard.com/dallas/' } },
  ...
  hutchins: { price: '제공', priceKind: 'estimate', priceNote: '저녁 제공', mapQuery: 'Hutchins BBQ Frisco McKinney Texas', mapNote: 'Confirm Frisco or McKinney with the group.', website: 'https://hutchinsbbq.com/', source: { label: 'Hutchins Frisco menu (price reference)', url: 'https://hutchinsbbq.com/frisco-menu/' } },
  karaoke: { price: '$20–40', priceKind: 'estimate', priceNote: '2시간정도 잡을 예정. 완전 한국 노래방이고 후불이니까 시간계산 잘해', mapQuery: 'Korean karaoke Carrollton TX', mapNote: '...' },
  'home-drinks': { ...home, price: '집에 있는거로 먹을건데 더 먹을거면 근처 마트에서 장보자', tip: '오래 대화하게 에너지 드링크 먹자' },
  'tex-mex': { price: '$20–35', priceKind: 'estimate', priceNote: '유명한데인데 마지막날이니까 간단히 먹자', mapQuery: 'Tex Mex Uptown Dallas TX', mapNote: '...', website: "https://www.google.com/maps/place/Las+Palmas+Tex-Mex/@32.7975219,-96.8052276,17z/data=!3m1!4b1!4m6!3m5!1s0x864e99b137c655a5:0xcfb3538f7a05612b!8m2!3d32.7975219!4d-96.8026527!16s%2Fg%2F11fj3rxysx?entry=ttu&g_ep=EgoyMDI2MDkwMi4wIKXMDSoASAFQAw%3D%3D " },
  'att-discovery': { price: '$0–15', priceKind: 'estimate', priceNote: '그냥 여기서 기념사진 몇개 찍고 아이스크림 먹을예정', mapQuery: 'AT&T Discovery District 208 S Akard St Dallas TX', website: 'https://discoverydistrict.att.com/', source: { label: 'Discovery District visitor information', url: 'https://discoverydistrict.att.com/' } },
  coffee: { price: '$5–10', priceKind: 'estimate', priceNote: '커피 안마셔도 됌 근처 스벅 찾아서 마시자', mapQuery: 'coffee Downtown Dallas TX', mapNote: '커피안마셔도 됌' },
